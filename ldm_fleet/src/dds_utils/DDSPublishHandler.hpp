...
#ifndef LDM_FLEET__SRC__DDS_UTILS__DDSPUBLISHHANDLER_HPP
#define LDM_FLEET__SRC__DDS_UTILS__DDSPUBLISHHANDLER_HPP
...
#endif // LDM_FLEET__SRC__DDS_UTILS__DDSPUBLISHHANDLER_HPP
